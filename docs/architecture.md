...
*How Bernard uses the same architecture to understand the world and navigate its own memories.*
...
The insight behind Bernard: **the same architecture that learns to predict the external world can learn to predict the structure of internal memory.**
