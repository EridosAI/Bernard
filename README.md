...
Protégé is an experiment in **raising** an AI rather than training it.
...
**Learning through interaction, not ingestion.** Most AI learns by consuming vast datasets in isolation. Protégé learns the way a new apprentice would — by watching, asking questions, and being corrected.
...
**Objects as meaning.** When I teach Protégé that this is a "multimeter," it doesn't just label pixels. It learns that multimeters appear alongside circuit boards, that I reach for them when debugging, that they make certain beeping sounds. Meaning emerges from context.

**Overnight dreaming.** During the day, Protégé watches and remembers. Overnight, it consolidates — training on the day's experiences, strengthening connections, building intuition. Separation of fast learning and slow integration.
...
**Protégé is heading toward a fully semantic architecture:**
...
This means Protégé could eventually understand "pass me that" + a pointing gesture + the sound of the thing I tapped on the bench — all fused into meaning without any of it becoming words until it responds.
...
I don't know if these ideas are right. Protégé is how I'm finding out.
