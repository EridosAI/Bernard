...
# Run main system
python jarvis_integrated_v2.py
...
| File | Purpose | Status |
|------|---------|--------|
| `jarvis_integrated_v2.py` | Main orchestration, capture loop, voice interface | ✅ Working |
...
4. Add integration points in `jarvis_integrated_v2.py`
